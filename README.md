...
- Se añadieron parámetros de versión a CSS y JavaScript (`?v=0.6.0`) para evitar que GitHub Pages o el navegador mantengan archivos anteriores en caché.
