window.ROMERIA_DATA = {
  ...
  services: [
    ...
    { id:'hy-01', type:'hydration', name:'Hidratación · Basílica', lat:9.8651, lng:-83.9141, status:'Disponible', note:'Punto demostrativo de hidratación para romeros.' },
    { id:'hy-02', type:'hydration', name:'Hidratación · Cartago Centro', lat:9.8666, lng:-83.9231, status:'Disponible', note:'Punto demostrativo para recarga de agua.' },
    { id:'hy-03', type:'hydration', name:'Hidratación · Taras', lat:9.8838, lng:-83.9360, status:'Disponible', note:'Punto demostrativo de hidratación en corredor de ingreso.' },
    { id:'hy-04', type:'hydration', name:'Hidratación · Ochomogo', lat:9.8950, lng:-83.9565, status:'Disponible', note:'Punto demostrativo para romeros.' },
    { id:'hy-05', type:'hydration', name:'Hidratación · Tres Ríos', lat:9.9060, lng:-83.9908, status:'Disponible', note:'Punto demostrativo de hidratación.' },

    { id:'mt-01', type:'meeting', name:'Punto de encuentro · Basílica', lat:9.8637, lng:-83.9115, status:'Activo', note:'Punto demostrativo de reunión y reagrupamiento.' },
    { id:'mt-02', type:'meeting', name:'Punto de encuentro · Cartago Centro', lat:9.8648, lng:-83.9197, status:'Activo', note:'Punto demostrativo para reunirse en caso de separación del grupo.' },
    { id:'mt-03', type:'meeting', name:'Punto de encuentro · La Lima', lat:9.8735, lng:-83.9384, status:'Activo', note:'Punto demostrativo de reagrupamiento.' },
    { id:'mt-04', type:'meeting', name:'Punto de encuentro · Ochomogo', lat:9.8942, lng:-83.9515, status:'Activo', note:'Punto demostrativo para situaciones de coordinación.' },
    { id:'mt-05', type:'meeting', name:'Punto de encuentro · Tres Ríos', lat:9.9070, lng:-83.9885, status:'Activo', note:'Punto demostrativo para reagrupamiento de romeros.' }
  ],
  reports: [
    {
      id:'OBJ-2026-014', category:'object', title:'Bolso pequeño encontrado',
      summary:'Bolso oscuro con elementos personales. Se omiten características de verificación.',
      stationId:'fp-01', institution:'Fuerza Pública', time:'11:25 a. m.', state:'En custodia',
      publicHint:'Para reclamarlo se requerirá describir características que no se publican.'
    },
    {
      id:'PER-2026-006', category:'person', title:'Persona ubicada en puesto de apoyo',
      summary:'Persona adulta que manifestó haberse separado de su grupo familiar.',
      stationId:'cr-02', institution:'Cruz Roja', time:'12:40 p. m.', state:'En acompañamiento',
      publicHint:'Se mantiene en el punto indicado mientras se gestiona el contacto familiar.'
    },
    {
      id:'MED-2026-003', category:'medical', title:'Traslado médico registrado',
      summary:'Atención de demostración con traslado a centro médico. No se publican datos clínicos ni identidad.',
      stationId:'cr-01', institution:'Cruz Roja', time:'1:05 p. m.', state:'Traslado realizado',
